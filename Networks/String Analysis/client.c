...
{ 
	...
	int sock = 0, valread_1,valread_2,valread_3; 
	...
	valread_1 = recv(sock, &chr, sizeof(int), 0 ); 
	valread_2 = recv(sock, &wrd, sizeof(int), 0); 

	valread_3 = recv(sock, &snt,  sizeof(int), 0); 
	
	printf("Sentences=%d Words=%d Characters=%d",snt,wrd,chr);
